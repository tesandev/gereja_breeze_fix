        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post" action="{{ isset($bacaan) ? route('bacaan.update', $bacaan->id) : route('bacaan.store') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full" :value="$bacaan->title ?? old('title')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-textarea-input id="content" name="content" class="mt-1 block w-full" required autofocus>{{ $bacaan->content ?? old('content') }}</x-textarea-input>
